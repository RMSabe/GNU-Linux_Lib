...
extern ssize_t _cstr_char_getlength(const char *str);
extern ssize_t _cstr_char_locatechar(const char *str, char c);

extern bool _cstr_char_compare(const char *str1, const char *str2);
extern bool _cstr_char_compare_upto_len(const char *str1, const char *str2, size_t stop_index, bool fail_if_nolen);
extern bool _cstr_char_compare_upto_char(const char *str1, const char *str2, char stop_char, bool fail_if_nochar);

extern bool _cstr_char_copy(const char *input_str, char *output_str, size_t bufferout_length);
extern bool _cstr_char_copy_upto_len(const char *input_str, char *output_str, size_t bufferout_length, size_t stop_index, bool append_nullchar);
extern bool _cstr_char_copy_upto_char(const char *input_str, char *output_str, size_t bufferout_length, char stop_char, bool append_nullchar);

extern bool _cstr_char_tolower(char *str, size_t buffer_length);
extern bool _cstr_char_toupper(char *str, size_t buffer_length);
